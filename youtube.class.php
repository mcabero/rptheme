...
class youtubeClass
{
    ...
    public function getEmbeb($width, $height, $autoplay)
    {
        return '<iframe class="youtube-player" type="text/html" width="'.$width.'" height="'.$height.'" src="http://www.youtube.com/embed/'.$this->id.'?autoplay='.$autoplay.'" frameborder="0" allowfullscreen>
        </iframe>';
    }
